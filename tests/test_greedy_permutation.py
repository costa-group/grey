...
class TestGreedyPermutation:
    ...
    def test_swap_element17(self):
        sfs, greedy_info = greedy_from_file("greedy_permutation_files/swap_element17.json")
    ...
    def test_swap_s2_s17(self):
        sfs, greedy_info = greedy_from_file("greedy_permutation_files/swap_s2_s17.json")
        seq = greedy_info.greedy_ids
        print("LEN", len(seq))
    ...
    def test_swap_s6_s17(self):
        sfs, greedy_info = greedy_from_file("greedy_permutation_files/swap_s6_s17.json")
        seq = greedy_info.greedy_ids
        print("LEN", len(seq))

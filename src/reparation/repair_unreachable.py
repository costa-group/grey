...
from graphs.algorithms import compute_dominance_tree, information_on_graph
...
def repair_unreachable_blocklist(cfg_blocklist: CFGBlockList, elements_to_fix: Set[var_id_T]):
    ...
    dominant_tree = compute_dominance_tree(cfg_blocklist.to_graph(),
                                           cfg_blocklist.start_block)
    construct_reachability(cfg_blocklist, dominant_tree)
...
def _debug_cfg_reachability(cfg_blocklist: CFGBlockList, dominant_tree: nx.DiGraph):

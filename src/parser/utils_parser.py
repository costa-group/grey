...
def replace_pos_instrsid(dependences, map_positions_instructions):
    ...
    for (i,j) in dependences:
        assert((i in map_positions_instructions) and (j in map_positions_instructions), "[ERROR]: position not found in map of instructions when genereting the dependences")
